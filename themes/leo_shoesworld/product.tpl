	...
	<meta itemprop="url" content="{$link->getProductLink($product)}">
		...
		<div class="pb-left-column col-xs-12 col-sm-12 col-md-12">
			...
			<p id="product_condition">
				<label id="condition_label">{l s='Condition:'}</label>
				...
				<div class="box-info-product">
					...
					<div class="product_attributes clearfix">
						...
						<p id="quantity_wanted_p"{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
							<label for="quantity_wanted" id="quantity_label">{l s='Quantity'}</label>
		...
		<div class="pb-center-column col-xs-12 col-sm-6 col-md-6">
			...
			<div class="box-cart-bottom">
				<a class="add_to_compare btn btn-outline buttons_bottom_block" href="{$link->getPageLink('products-comparison')|escape:'html':'UTF-8'}" data-id-product="{$product->id|intval}" title="{l s='Add to compare'}" >
		...
		<div class="pb-centercolumn col-xs-12 col-sm-12 col-md-12">
