	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function($){{/literal}
			...
			$(".lof-clock-{$product.id_product|intval}-detail").lofCountDown({literal}{{/literal}
				...
				DisplayFormat:'<li class="z-depth-1 day">%%D%%<span>'+text_d+'</span></li><li class="z-depth-1">%%H%%<span>'+text_h+'</span></li><li class="z-depth-1">%%M%%<span>'+text_m+'</span></li><li class="z-depth-1">%%S%%<span>'+text_s+'</span></li>',
