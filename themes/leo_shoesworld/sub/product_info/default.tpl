							...
							<div class="product_block col-xs-12 col-sm-6 col-md-3 col-lg-3 item ajax_block_product{if $smarty.foreach.accessories_list.first} first_item{elseif $smarty.foreach.accessories_list.last} last_item{else} item{/if} product_accessories_description">
								<div class="product-container text-center product-block" itemscope itemtype="https://schema.org/Product">
									<div class="left-block">
										<div class="product-image-container image ">
											<a href="{$accessoryLink|escape:'html':'UTF-8'}" title="{$accessory.legend|escape:'html':'UTF-8'}" class="product-image product_image">
												<img class="lazyOwl" src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'home_default')|escape:'html':'UTF-8'}" alt="{$accessory.legend|escape:'html':'UTF-8'}" itemprop="image" />
											</a>
									...
									<div class="right-block">				
										<h5 itemprop="name" class="product-name name">
											...
											<div itemprop="price" class="content_price">
												<span class="price">
													{if $priceDisplay != 1}
										...
										<div class="functional-buttons clearfix" >
											{if isset($quick_view) && $quick_view}
												<a class="quick-view blueRounded" href="{$accessory.link|escape:'html':'UTF-8'}" rel="{$accessory.link|escape:'html':'UTF-8'}" data-original-title="{l s='Quick view'}">
													<i class="fa fa-eye"></i>
												</a>
											{/if}
											<a itemprop="url" class="lnk_view blueRounded" href="{$accessory.link|escape:'html':'UTF-8'}" title="{l s='View'}">
											...
											{if !$PS_CATALOG_MODE && ($accessory.allow_oosp || $accessory.quantity > 0)}
												<div class="no-print">
													<a class="exclusive button ajax_add_to_cart_button btn blueRounded" href="{$link->getPageLink('cart', true, NULL, "qty=1&amp;id_product={$accessory.id_product|intval}&amp;token={$static_token}&amp;add")|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product|intval}" title="{l s='Add to cart'}">
